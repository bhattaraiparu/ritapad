      ...
      <div class="input-field col s12">
       ...
       <div class="input-field col s12">
         <select>
           ...
           <option value="Congo_Democratic_Republic_of">Congo, Democratic
           Republic of</option>
           ...
           <option value="Pan_Latin_America">Pan-Latin America</option>
           ...
           <option value="Samoa">Samoa (US)</option>
           <option value="Samoa_w">Samoa (Western)</option>
           ...
           <option value="ST_Vincent_and_the_Grenadines">St Vincent and the
           Grenadines</option>
           ...
           <option value="Tajiikistan">Tajiikistan</option>
